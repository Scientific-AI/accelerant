...
write_info_file(here, 'accelerant', doc=README, license=LICENSE,
...
setup_kwds = dict(
    name='accelerant',
    version=__version__,
    description='accelerant for scientific automation',
    ...
    url = 'https://github.com/Scientific-AI/accelerant',
    download_url = 'https://pypi.org/project/accelerant/#files',
    project_urls = {
        'Documentation':'http://accelerant.rtfd.io',
    ...
    classifiers = [
        ...
        'License-Expression :: OSI Approved :: BSD-3-Clause',
    ...
    packages = ['accelerant','accelerant.tests'],
    package_dir = {'accelerant':'accelerant','accelerant.tests':'accelerant/tests'},
)
